...
package: ## Package the code for AWS Lambda
	...
	@tar -xzf resources/traveling-ruby-20150715-2.1.6-linux-x86_64.tar.gz -C $(LAMBDADIR)/lib/ruby
...
run: ## Runs the code locally
	...
	@tar -xzf resources/traveling-ruby-20150715-2.1.6-osx.tar.gz -C $(OSXDIR)/lib/ruby
